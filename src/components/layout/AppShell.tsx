...
export const AppShell: React.FC<AppShellProps> = ({ children }) => {
  return (
    <div className="relative h-screen w-screen bg-[#F4F7F6] text-slate-900 selection:bg-[#217C70] selection:text-white flex overflow-hidden">
      ...
      {/* Main Container (Independent Right Scrollable Area) */}
